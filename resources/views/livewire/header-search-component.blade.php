    ...
    <div class="wrap-search-form">
        <form action="{{ route('product.search') }}" id="form-search-top" name="form-search-top">
            ...
            <div class="wrap-list-cate">
                <input type="hidden" name="product_category" value="{{ $product_category }}" id="product-category">
                <input type="hidden" name="product_category_id" value="{{ $product_category_id }}" id="product-category-id">
